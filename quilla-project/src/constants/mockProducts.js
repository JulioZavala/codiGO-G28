export const MOCK_PRODUCTS = [
  {
    sku: "ME-AC-WL-03-BK-U",
    name: "Billetera Compacta",
    description:
      "Billetera Compacta en color black. Compacta y resistente, con ranuras para tarjetas y espacio para billetes y documentos.",
    category: "hombre",
    subcategory: "accesorios",
    sub_subcategory: "billeteras",
    price: 320.0,
    discount: null,
    stock_quantity: 1,
    images: [
  ...
  {
    sku: "WO-BA-SH-01-BK-S",
    name: "Cartera Shoulder de Cuero",
    description:
      "Cartera Shoulder de Cuero en color black. Cuero resistente, costuras finas y organizacion practica. Perfecto para uso diario con un toque sofisticado.",
    category: "mujer",
    subcategory: "bolsos",
    sub_subcategory: "shoulder-bag",
    price: 1060.0,
    discount: "15%",
    stock_quantity: 34,
    images: [
  ...
  {
    sku: "ME-JK-JK-05-TN-S",
    name: "Casaca Suede Minimal",
    description:
      "Casaca Suede Minimal en color tan. Corte moderno, cuero suave y acabados premium. Ideal para elevar looks diarios con comodidad.",
    category: "hombre",
    subcategory: "casacas",
    price: 1600.0,
    discount: null,
  ...
  {
    sku: "WO-AC-MR-03-CG-L",
    name: "Morral de Cuero",
    description:
      "Morral de Cuero en color cognac. Cuero resistente, costuras finas y organizacion practica. Perfecto para uso diario con un toque sofisticado.",
    category: "mujer",
    subcategory: "accesorios",
    sub_subcategory: "morral",
    price: 1390.0,
    discount: "20%",
    stock_quantity: 27,
    images: [
  ...
  {
    sku: "UX-WL-WL-03-OL-U",
    name: "Billetera Compacta",
    description:
      "Billetera Compacta en color olive. Compacta y resistente, con ranuras para tarjetas y espacio para billetes y documentos.",
    category: "mujer",
    subcategory: "unisex",
    price: 270.0,
    discount: "50%",
